...
| **dynarec** — x86 basic blocks → ARM64 code, lazy flags, callouts to the interpreter for the rest | [`docs/DYNAREC.md`](docs/DYNAREC.md), [`core/src/jit/`](core/src/jit) — **passes all 2364 silicon vectors on the M3 iPad** (and under qemu-aarch64 / Apple-silicon CI); runs i386 and x86-64 guests end to end |
