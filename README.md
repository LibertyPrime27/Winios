...
| Engine B — 64-bit (Wine + dynarec, wineserver as extension) | **blocked** on the extension memory-limit measurement |
...
2. **Everything 64-bit depends on one unmeasured number:** whether an iOS app extension can hold ~3 GB resident. Apple's docs say no; LiveContainer's author says yes. Measuring it is the first task, and it takes a day.
